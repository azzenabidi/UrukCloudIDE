    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Messages Box      </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                    ...
                                    <tbody>
                                      ...
                                      while ($data=$result->fetch())
                                      {
                                        ...
                                        echo '<tr class="odd gradeC">';
                                            ...
                                            echo"<td>".$data['message_content']."</td>";
                                            echo"<td>".$data['message_time']."</td>";
                                            $secondresult=$user->search_action($data['user_id']);
                                            while ($data2=$secondresult->fetch())
                                            {
